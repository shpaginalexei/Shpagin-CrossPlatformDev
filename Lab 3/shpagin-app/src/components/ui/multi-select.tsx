          ...
          {selected.map((option) => {
            return (
              <div
                key={option.value}
                className={cn(
                  "animate-fadeIn dark:bg-input/30 text-secondary-foreground relative inline-flex h-7 cursor-default items-center rounded-md border bg-transparent pr-7 pl-2 text-xs font-medium transition-all disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 data-fixed:pr-2",
                  badgeClassName,
                )}
